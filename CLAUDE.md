...
Sieggy set a global writing standard on 2026-08-10 and revised it on 2026-08-18. It lives in `~/.claude/CLAUDE.md`, which
...
**GitHub status:** this checkout has `origin/main`; the source and cited Git objects above are present locally. `.env` is gitignored. No secrets in source.
